...
if($rowcount == 30){
    echo"<script languaje ='JavaScript'>alert('Curso lleno');
     ...
     $usuario=$_GET['usuario'];  
            ...
            $consulta2 = "SELECT * from c where id_reg='$idreg'";
            ...
            $consulta = "INSERT INTO c(usuario_reg,fecha_reg,id_reg) VALUES ('$usuario','$fechareg','$idreg')";
   ...
   <table>
     <tr>
      <td><a href="https://rubenxr.com/cursos/"><img src="https://i.imgur.com/P5kNREk.png"><a>
      </td>
     </tr>
    </table>
    </body>
...
EOF;
            ...
            Su registro al curso de C# fue un exito. <br>
            ...
            El usuario $usuario se registro al curso 'C#'. <br>
