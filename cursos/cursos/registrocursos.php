...
if($rowcount == 30){
    echo"<script languaje ='JavaScript'>alert('Curso lleno');
     ...
     $usuario=$_GET['usuario'];  
            $fechareg = date("d/m/y");
            $curso='Python';
            $idreg ='py'.$usuario.'thon';
            
            $consulta2 = "SELECT * from python where id_reg='$idreg'";
            ...
            $consulta = "INSERT INTO python(usuario_reg,fecha_reg,id_reg) VALUES ('$usuario','$fechareg','$idreg')";
   ...
   <table>
     <tr>
      <td><a href="https://rubenxr.com/cursos/"><img src="https://i.imgur.com/VdATH4U.png"><a>
      </td>
     </tr>
    </table>
    </body>
...
EOF;
            ...
            Su registro al curso de Python fue un exito. <br>
            ...
            El usuario $usuario se registro al curso 'Python'. <br>
