...
if($rowcount == 30){
    echo"<script languaje ='JavaScript'>alert('Curso lleno');
     ...
     $usuario=$_GET['usuario'];  
            $fechareg = date("d/m/y");
            $curso='JavaScript';
            $idreg ='jav'.$usuario.'script';
            
            $consulta2 = "SELECT * from javascript where id_reg='$idreg'";
            ...
            $consulta = "INSERT INTO javascript(usuario_reg,fecha_reg,id_reg) VALUES ('$usuario','$fechareg','$idreg')";
   ...
   <table>
     <tr>
      <td><a href="https://rubenxr.com/cursos/"><img src="https://i.imgur.com/TY2R3UD.png"><a>
      </td>
     </tr>
    </table>
    </body>
...
EOF;
            ...
            Su registro al curso de JavaScript fue un exito. <br>
            ...
            El usuario $usuario se registro al curso 'JavaScript'. <br>
